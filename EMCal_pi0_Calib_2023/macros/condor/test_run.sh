...
#./test_run.sh 100 dst_calo_cluster.list dst_truth.list dst_global.list
#which runs it as 
# root -l -q "Fun4All_EMCal_sp.C(100, dst_calo_cluster.list, dst_truth.list, dst_global.list)"
...
input_file3="/sphenix/user/nkumar/analysis/EMCal_pi0_Calib_2023/macros/condor/${global_list}"
