...
int CaloAna::Init(PHCompositeNode*)
{
  ...
  h_pi0_ELoss_2d = new TH2F("h_pi0_ELoss_2d", "pT vs Eloss", 8 * 10, 0, 20, 2000, -10, 10);
  h_pi0_ERatio_2d = new TH2F("h_pi0_ERatio_2d", "pT vs ERatio", 8 * 10, 0, 20, 1000, 0, 10);
  h_eta_ELoss_2d = new TH2F("h_eta_ELoss_2d", "pT vs Eloss", 8 * 10, 0, 20, 2000, -10, 10);
