...
int CaloAna::Init(PHCompositeNode*)
{
  ...
  h_truthmatched_mass3_2d = new TH2F("h_truthmatched_mass3_2d", "pT vs Invariant Mass, truth matched(delR<0.2)", 4 * 10, 0, 10, 240, 0, 1.2);
...
int CaloAna::process_towers(PHCompositeNode* topNode)
{
  ...
  float pt1ClusCut = 1.2;  // centrality dependence cuts 2.2 for both // 1.3
